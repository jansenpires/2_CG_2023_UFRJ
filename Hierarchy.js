...
var headMatrix = new Matrix4()
  .setTranslate(0, 9.5, 0)
  .rotate(joint.head, 0, 1, 0);

var torsoMatrixLocal = new Matrix4().setScale(2, 25, 2);
var shoulderMatrixLocal = new Matrix4().setScale(5,2,5);
var armMatrixLocal = new Matrix4().setScale(1.5, 1.5, 1.9);
var handMatrixLocal = new Matrix4().setScale(25, 1, 1);
var headMatrixLocal = new Matrix4().setScale(5,5,5);
...
function handleKeyPress(event) {
  ...
  switch (ch) {
    ...
    case "g":
      joint.head += 15;
      headMatrix.setTranslate(0, 10, 0).rotate(joint.head, 0, 1, 0);
      break;
    case "G":
      joint.head -= 15;
      headMatrix.setTranslate(0, 10, 0).rotate(joint.head, 0, 1, 0);
...
window.addEventListener("load", (event) => {
  ...
  (function animate() {
    ...
    if(is_rolling){
      armMatrix.rotate(ang, 0,0,1);
    }else{
      armMatrix.rotate(0,0,0,1);
    }
